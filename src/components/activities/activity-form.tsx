...
export function ActivityForm({ semesters, organizations, programs }: { semesters: Option[]; organizations: Option[]; programs: ProgramOption[] }) {
  ...
  return <>
    ...
    <dialog id="activity-modal" className="w-[min(680px,calc(100%-2rem))] rounded-3xl border border-[var(--line)] bg-[var(--background)] p-0 text-[var(--ink)] shadow-2xl backdrop:bg-[#10261b]/40 backdrop:backdrop-blur-sm">
