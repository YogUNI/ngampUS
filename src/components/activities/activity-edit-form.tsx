          ...
          <div className="relative my-auto max-h-[90vh] w-full max-w-xl overflow-y-auto rounded-3xl border border-[var(--line)] bg-white p-6 sm:p-7 shadow-2xl">
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-3">
                <select name="jenis_item" defaultValue={activity.jenis_item}>
                ...
                <select name="prioritas" defaultValue={activity.prioritas}>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <select name="program_id" defaultValue={activity.program_id || ""} disabled={!selectedOrgId}>
